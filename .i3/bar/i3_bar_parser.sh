...
while read -r line ; do
    case $line in
        ...
        DAT*)
          # Date
          date="%{F${color_sec_b1}}%{F${color_lgray} B${color_sec_b1}} %{T2}Õ%{F- T-} ${line#???} "
          ;;
        VOL*)
          # Volume
          vol="%{F${color_sec_b2}}%{F${color_lgray} B${color_sec_b2}} %{T2}Ô%{F- T-} ${line#???}%%  "
          ;;
        SYS*)
          # conky
          sys_info="${line#???}"
        ...
        GMA*)
          ...
          if [ "${n_mail}" != "0" ]; then
            ...
            gmail="%{F${color_sec_b1}}%{F${color_lgray} B${color_sec_b1}} %{T2}Ó%{F- T-} ${n_mail}   "
          fi
          ;;
        IRC*)
          ...
          if [ "${line#???}" != "0" ]; then
            ...
            irc="%{F${color_sec_b2}}%{F${color_lgray} B${color_sec_b2}} %{T2}Ò%{F- T-} ${irc_n_high} %{F${color_lgray}} %{T2}Á%{F- T-} ${irc_high}  "
          fi
          ;;
        WIN*)
          # window title
    ...
    printf "%s\n" "%{l}${title} %{r}${irc}${gmail}${sys_info}${vol}${date}${time}"
