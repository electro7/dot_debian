...
function! airline#themes#air_e7#refresh()
  ...
  let g:airline#themes#air_e7#palette.insert.airline_a = ['#000000', '#de935f', 16, 3, '']
  let g:airline#themes#air_e7#palette.insert_paste = {
              \ 'airline_a': ['#000000', '#de935f', 16 , 3, ''] ,
              \ }
  ...
  let g:airline#themes#air_e7#palette.visual.airline_a = ['#000000', '#5f919d', 16, 4]
  let g:airline#themes#air_e7#palette.visual.airline_z = ['#000000', '#5f919d', 16, 4]
