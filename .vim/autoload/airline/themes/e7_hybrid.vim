...
" Insert mode
let s:I1 = [ s:g_b_blue   , s:g_b_black  , s:c_b_blue    , s:c_b_black  ]
...
" Normal mode
let g:airline#themes#e7_hybrid#palette.normal =
  \ airline#themes#generate_color_map(s:N1, s:N2, s:N3)
let g:airline#themes#e7_hybrid#palette.normal.airline_a =
  \ [ s:g_d_black, s:g_b_green, s:c_d_black, s:c_b_green ]
let g:airline#themes#e7_hybrid#palette.normal.airline_b =
  \ [ s:g_b_green, s:g_d_black, s:c_b_green, s:c_d_black ]

" Insert mode
let g:airline#themes#e7_hybrid#palette.insert =
  \ airline#themes#generate_color_map(s:I1, s:I2, s:I3)
let g:airline#themes#e7_hybrid#palette.insert.airline_a =
  \ [ s:g_d_black, s:g_b_blue, s:c_d_black, s:c_b_blue ]
let g:airline#themes#e7_hybrid#palette.insert.airline_b =
  \ [ s:g_b_blue, s:g_d_black, s:c_b_blue, s:c_d_black ]

" Visual mode
let g:airline#themes#e7_hybrid#palette.visual =
  \ airline#themes#generate_color_map(s:V1, s:V2, s:V3)
let g:airline#themes#e7_hybrid#palette.visual.airline_a =
  \ [ s:g_d_black, s:g_b_cyan, s:c_d_black, s:c_b_cyan ]
let g:airline#themes#e7_hybrid#palette.visual.airline_b =
  \ [ s:g_b_cyan, s:g_d_black, s:c_b_cyan, s:c_d_black ]

" Replace mode
let g:airline#themes#e7_hybrid#palette.replace =
  \ airline#themes#generate_color_map(s:R1, s:R2, s:R3)
let g:airline#themes#e7_hybrid#palette.replace.airline_a =
  \ [ s:g_d_black, s:g_b_red, s:c_d_black, s:c_b_red ]
let g:airline#themes#e7_hybrid#palette.replace.airline_b =
